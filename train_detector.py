...
import argparse
from utils.trainer import train_detector

parser = argparse.ArgumentParser("train detector")
...
parser.add_argument("--detector_weight", type=str, default=None, help='path of detector weight')
parser.add_argument("--log_file", type=str, default='', help='log file')
parser.add_argument("--epoch", type=int, default=200, help='size of input image')
...
train_detector(model_save_path=args.weight_save_path,
               ...
               target=None,
               attack_method=None,
               pretrained_model=args.detector_weight,
