...
def RefinedNet(lr):
    ...
    rgb = Input(shape=(None, None, 3))
    # fine = feature_sum
    fine = DepthwiseConv2D(depth_multiplier=3, kernel_size=(5, 5), padding='same', depthwise_initializer=srm_init)(rgb)
    fine.trainable = False
    ...
    out = Conv2D(1, 7, padding='same', activation='sigmoid', name='out2')(x6)
